...
using namespace cv;
using namespace std;
#define SavePatch "E:\\TestDate\\hudeilan\\Date\\测试\\测试01.txt"
#define Patch "E:\\TestDate\\hudeilan\\Date\\tf1_1.jpg"
string SaveImageDirPatch = "E:\\TestDate\\hudeilan\\Date\\测试\\";
string SaveImageName = "测试01 ";
...
double Contours(Mat src)
{
	...
	RNG rng(0);
		...
		drawContours(dst, contours, 8, color, 2, LINE_AA, hierarchy, 0, Point(0, 0));	//1 4 5 6 7 8
		//drawContours(
	...
	//{
		ConArea += contourArea(contours[8]);
	/*}*/
	return ConArea;
}
